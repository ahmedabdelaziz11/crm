    ...
    <body>
        <div class ="container">
            ...
            <div style="padding: 10px"   > 
                <a class="btn btn-secondary" href="?page=Admin"> Admins</a>
                <a class="btn btn-secondary" href="?page=Employee"> Employees</a>
                <a class="btn btn-secondary" href="?page=Plan"> Plans</a>
                <a class="btn btn-secondary" href="?page=showCustomers"> view Customers</a>
                <a class="btn btn-secondary" href="?page=showComplaints"> view complaints</a> 
                                              
            </div>
            <div class="clear"></div>
            <div id ="contents" style="padding-left:150px">

                <section "id="page">
                    <?php
                    if(@$_GET['page']){
                        $url = "../../controllers/admin/" . $_GET['page'] . ".php" ;
                        if(is_file($url)) {
                        include $url;
                        } else {
                        echo 'error';
